/* ══════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════ */
  /* ── שורות שאינן ארוחה ──
     הסוכן נוהג להוסיף "סיכום יומי" או "סה״כ" כשורה במערך הארוחות.
     הפרומפט כבר אוסר את זה במפורש, אבל פרומפט הוא בקשה ולא ערובה —
     ואצל המתאמן זה הופיע כאריח לכל דבר: 0 קק"ל, "בחר וסמן", ואין
     מה לסמן בו.
  ...
  function stripNonMeals(plan) {
    ...
    const kept = plan.filter(m => m && !NON_MEAL_RE.test(String(m.meal || '')));
    return { plan: kept, dropped: plan.length - kept.length };
  }
